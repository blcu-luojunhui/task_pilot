...
import { HtmlContent } from '@/components/trace/HtmlContent';
            ...
            title: (
              <Space direction="vertical" size={2} style={{ width: '100%' }}>
                ...
                {result && (
                  ...
                  >
                    <HtmlContent content={result.content} />
                  </div>
                )}
              </Space>
            ),
        ...
        ? [
            {
              ...
              title: (
	                <div
	                  ...
	                  style={{ fontSize: 12, background: palette.stepBg, padding: 8, borderRadius: 4 }}
	                >
